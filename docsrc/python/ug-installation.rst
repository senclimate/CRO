...
You may skip this step if :code:`mamba` is already installed in your environment.

If you already have :code:`conda` installed, you only need to install :code:`mamba` using:

.. code-block:: bash

    conda install -n base -c conda-forge mamba

Otherwise, follow the three steps below.
