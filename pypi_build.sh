#!/usr/bin/env bash
# =========================================================
# pypi_build.sh - Build and publish XRO package
# Usage:
#   ./pypi_build.sh local     # Build and install locally
#   ./pypi_build.sh test      # Upload to TestPyPI
#   ./pypi_build.sh pypi      # Upload to PyPI
# =========================================================
